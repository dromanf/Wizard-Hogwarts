...
export class FormComponent implements OnInit {
    ...
    // Se recibe la matriz de solicitudes que se almacenan en el localStorage
    solicitudes!: SolicitudInterface[];
    // Se usa la tabla como referencia de datos
    dataSource = new MatTableDataSource<SolicitudInterface>(this.solicitudes);

    // Referencia para las opciones de 'mat-select' en el formulario
